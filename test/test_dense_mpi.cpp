...
int main(int argc, char** argv) {
    ...
    registerUpdateAccelerationFns(localParticlesX, gravityUpdateAcceleration);
    registerUpdateAccelerationFns(localParticlesY, gravityUpdateAcceleration);
    for(int iter=0; iter<100; iter++) {
        update(localParticlesX, localParticlesY, &topology, 1e-1);
    }
